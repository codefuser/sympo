...
// 1. Image-a import pannunga
// Unga assets folder-la irukira file name-ukku yethapola ithai mathikonga
// import upiQrImage from "@/assets/qr-code.png"; 

const GOOGLE_FORM_URL = "https://docs.google.com/forms/d/e/1FAIpQLScChLyBESZ8snIWtNv7F_o2KRss4-xyckU9As076UskRd93AA/viewform?embedded=true";
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="card-glow rounded-xl p-5 border border-primary/20">
            ...
            <div className="flex flex-col sm:flex-row gap-5 items-center">
              ...
              <div className="shrink-0 w-40 h-40 rounded-xl border-2 border-primary/40 bg-white flex items-center justify-center overflow-hidden">
                <img 
                  src={upiQrImage} 
                  alt="UPI QR Code" 
