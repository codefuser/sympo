import { Zap, Mail, Phone, MapPin, Instagram, Twitter, Youtube, FacebookIcon } from "lucide-react";
...
Thamirabharani Engineering College.
          ...
          <div>
            <p className="font-display text-xs text-primary tracking-widest uppercase mb-4">Contact Us</p>
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li className="flex items-center gap-2"><Mail className="w-3 h-3" /> tecece9531@gmail.com</li>
              <li className="flex items-center gap-2"><Phone className="w-3 h-3" /> +91 7708 685 345</li>
              <li className="flex items-center gap-2"><MapPin className="w-3 h-3" /> Thamirabharani Engineering College,
Tirunelveli, Tamil Nadu</li>
            </ul>
          </div>
          <div>
