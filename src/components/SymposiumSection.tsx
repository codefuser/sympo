      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h2 className="font-display text-3xl md:text-5xl font-bold text-foreground mb-4">
            About <span className="gradient-text">FUTRONIX'26</span>
          </h2>
        ...
        <div className="grid md:grid-cols-1 gap-12 items-center mb-16">
          <div>
            <p className="text-muted-foreground leading-relaxed  mb-6">
              {/* text-lg */}
              FUTRONIX’26 is a National Level Technical Symposium organized by
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              ...
              FUTRONIX’26 provides a platform for students to enhance their
